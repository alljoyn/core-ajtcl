...
#define AJ_RELEASE_YEAR        16       /**< release year */
#define AJ_MAJOR_VERSION       AJ_RELEASE_YEAR /**< deprecated */
#define AJ_RELEASE_MONTH       10       /**< release month */
#define AJ_MINOR_VERSION       AJ_RELEASE_MONTH /**< deprecated */
#define AJ_FEATURE_VERSION     2        /**< feature version */
#define AJ_RELEASE_VERSION     AJ_FEATURE_VERSION /**< deprecated */
#define AJ_BUGFIX_VERSION      0        /**< bugfix version */
#define AJ_RELEASE_YEAR_STR    16       /**< release year string (two digits) */
#define AJ_RELEASE_MONTH_STR   10       /**< release month string (two digits) */
#define AJ_FEATURE_VERSION_STR 02       /**< feature version string (00, 01, 02, ...) */
#define AJ_BUGFIX_VERSION_STR           /**< bugfix version string (blank, a, b, ...) */
#define AJ_RELEASE_TAG         "v16.10.02"
